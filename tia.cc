...
bool TIA::should_draw_player(int visible_x, int player_x, uint8_t player_mask,
...
bool TIA::should_draw_missile(int visible_x, int missile_x, int missile_size,
...
void TIA::process_tia_cycle() {
  if (!vblank_mode) {
    ...
    bool player0 = should_draw_player(visible_x, player0_x, player0_mask,
                                      player0_duplicate_mask, player0_scale);
    bool player1 = should_draw_player(visible_x, player1_x, player1_mask,
                                      player1_duplicate_mask, player1_scale);
    bool missile0 =
        should_draw_missile(visible_x, missile0_x, missile0_size,
                            missile0_enable, player0_duplicate_mask);
    bool missile1 =
        should_draw_missile(visible_x, missile1_x, missile1_size,
...
TIA::TIA() {
  dma_region = std::make_shared<DmaRegion>(
      TIA_START, TIA_END, std::bind(&TIA::dma_read_hook, this, _1),
      std::bind(&TIA::dma_write_hook, this, _1, _2));

...
atari2600: main.o registers.o memory.o operand.o instructions.o cpu.o qt_display.o display.o ntsc.o
	${CC} main.o registers.o memory.o operand.o instructions.o cpu.o qt_display.o display.o ntsc.o -o atari2600
